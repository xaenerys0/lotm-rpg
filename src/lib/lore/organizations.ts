...
export const ORGANIZATION_LORE: LoreEntry[] = [
  ...
  {
    // CORPUS: issue #213 capture, corpus-verified
    slug: "moses-ascetic-order-present-day",
    title: "The Moses Ascetic Order — In the Present Day",
    category: "organization",
    content: `The Moses Ascetic Order persists as a secret order of Hermit-pathway warlocks who worship the Hidden Sage — the pathway's knowledge come to life — as their god. Founded in the Fourth Epoch by humans who had read a Blasphemy Slate, it began as morally upright pursuers of knowledge under the maxim "Do as you wish, but do no harm," on good terms with the orthodox Churches. It curdled when that abstract ideal awoke into a real, whispering existence: the Hidden Sage now tests every Hermit-pathway Beyonder by pouring knowledge into their ears, and those who cannot assimilate it are driven to raving madness. Its members lead ascetic, silent lives to endure that pressure, and find it comparatively safe to listen — their great advantage and their leash. Cattleya, later a Pirate Queen and the Tarot Club's Hermit, was once one of the Order's ten Pillars; she nearly lost control to the Sage before Mr. Fool pulled her into the gray fog. Against the Order stands the Element Dawn, founded by Queen Mystic Bernadette Gustav to fight it. Its strongholds stay hidden and its members scatter among scholars and navigators, known — when at all — by knowledge no honest study could earn.`,
    epoch: 5,
    npcs: ["Hidden Sage", "Cattleya", "Bernadette Gustav", "Mr. Fool"],
    sequences: [6],
    tags: [
      "moses-ascetic-order",
      "hermit-pathway",
  ...
  {
    // CORPUS: issue #213 capture, corpus-verified
    slug: "secret-order-present-day",
    title: "The Secret Order — In the Present Day",
    category: "organization",
    content: `The Secret Order endures into the present as one of the world's most secretive Beyonder organizations — the Fool-pathway conspiracy the Zaratul Family founded at the close of the War of the Four Emperors. Its goals and philosophy remain unknown even to most of the hidden world; what is known is its hunger for the relics of the destroyed Antigonus Family, and its depth inside the Intis Republic, where it constitutes Bureau 8 of the Republic's intelligence apparatus. The Order rarely acts openly. Its members surface as collectors, brokers, and quiet inquirers after old notebooks and Fool-pathway antiquities — it once held the Antigonus Family's Notebook itself, lost it to a careless sale, and dispatched agents as far as Tingen to recover it. Its founder and leader Zaratul vanished long ago into a botched Sequence 1 advancement, and mystical circles now whisper of a reshuffling within the Order's Intis ranks, as if something long absent had returned to take up the reins.`,
    epoch: 5,
    npcs: ["Zaratul"],
    sequences: [7],
    tags: [
