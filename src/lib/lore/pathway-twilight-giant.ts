...
export const TWILIGHT_GIANT_PATHWAY_LORE: LoreEntry[] = [
  {
    slug: "twilight-giant-pathway-overview",
    title: "Twilight Giant Pathway — Overview",
    category: "pathway",
    ...
    npcs: [],
    sequences: [9, 8, 7, 6, 5],
    tags: ["twilight-giant-pathway", "eternal-darkness-group", "overview"],
    tokenCount: 170,
  },
];
