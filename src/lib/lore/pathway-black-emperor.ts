...
export const BLACK_EMPEROR_PATHWAY_LORE: LoreEntry[] = [
  {
    slug: "black-emperor-pathway-overview",
    title: "Black Emperor Pathway — Overview",
    category: "pathway",
    ...
    tags: ["black-emperor-pathway", "order-group", "overview"],
    tokenCount: 212,
  },
];
